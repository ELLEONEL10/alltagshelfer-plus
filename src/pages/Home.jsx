    ...
    <div className="py-10 md:py-16 space-y-10 bg-white dark:bg-slate-950 transition-colors duration-300">
      <section className="container mx-auto px-4 pt-8 md:pt-14">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(45,131,144,0.16),transparent_34%),radial-gradient(circle_at_bottom_left,rgba(219,141,105,0.14),transparent_26%)] pointer-events-none" />
            ...
            <div className="relative mx-auto w-full max-w-[1200px] lg:max-w-none animate-fadeScale h-[420px] md:h-[560px] lg:h-[720px]">
                <div className="absolute inset-0 rounded-full bg-gold-primary/12 blur-3xl animate-pulseSoft" />
                <div className="absolute left-[6%] top-[12%] h-20 w-20 rounded-full border border-navy-light/12 animate-float-slow" />
                <div className="absolute right-[-6%] bottom-[6%] h-28 w-28 rounded-full border border-gold-primary/18 animate-float" />
                <img
                  src={homepageArt}
                  alt="Alltagshelfer Plus Herz"
                  style={{ right: '-6vw' }}
                  className="absolute top-0 bottom-0 -right-6 w-[130%] h-full object-contain object-right translate-x-6 lg:translate-x-20 scale-[1.25] lg:scale-[1.35] z-10 opacity-100 animate-slideInRight animate-float-slow drop-shadow-[0_70px_220px_rgba(16,55,64,0.2)]"
                />
            </div>
          </div>
        </div>
